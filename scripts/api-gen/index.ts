...
async function main() {
  ...
  const swaggerBaseDir = resolve(
    projectRoot,
    '../ai-boilerplate-backend/doc/swagger/admin',
  );
  const outputBaseDir = resolve(projectRoot, 'apps/web-antd/src/api');
